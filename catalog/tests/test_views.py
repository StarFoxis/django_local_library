...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_num in range(number_of_authors):
            Author.objects.create(first_name=f'Christian {author_num}', \
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borreowed_books_in_list(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('my-borrowed'))
...
class renewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username='testuser2', password='12345')
        test_user2.save()
        permission = Permission.objects.get(name='Rabotai tvar')
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        resp = self.client.post(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance2.pk}), {'renewal_date': date_in_past})
        self.assertEqual(resp.status_code, 200)
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        resp = self.client.post(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance2.pk}), {'renewal_date': invalid_date_in_future})
        self.assertEqual(resp.status_code, 200)
